...
var tipoRicerca = 2;
var pagina = 1;
var api_url_getall = "https://www.eporner.com/api/v2/video/search/?order=latest&lq=1&format=json&gay=0&per_page=30";
...
function Ricerca() {
    ...
    switch (tipoRicerca) {
        case 1:
            ...
            intestazione.innerHTML = `Page <span id="categoria">${pagina}</span>`;
            break;
        case 2:
            tipoRicerca = 2;
            intestazione.innerHTML = "";
            ...
            fetch("https://www.eporner.com/api/v2/video/search/?page=" + pagina + "&lq=1&format=json&order=latest&per_page=30&query=" + key_word, {
                ...
                .then(result => { stampaCards(result) })
                .catch(error => console.log('Error:', error));
            intestazione.innerHTML = "Search by <span id='ricerca'>" + key_word + "</span>";
            break;
        case 3:
            ...
            if (time == "longest") {
                intestazione.innerHTML = "Search by <span id='ricerca'>Long Videos</span>";
            } else {
                intestazione.innerHTML = "Search by <span id='ricerca'>Short Videos</span>";
            }
...
function stampaCards(result) {
    ...
    arrayVideo.forEach((video, index) => {
        ...
        imgViews.src = `/Tap-fap-main/img/eye.png`;
        imgViews.id = `views`;
        ...
        imgTime.src = `/Tap-fap-main/img/clock-circular-outline.png`;
        imgTime.id = `clock`;
